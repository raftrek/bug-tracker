...
export const INITIAL_ISSUES: Issue[] = [
  {
    ...
    assignee: { name: 'Alice Johnson', avatarUrl: 'https://i.pravatar.cc/150?u=AliceJohnson' },
    status: Status.TODO,
  ...
  },
  {
    ...
    assignee: { name: 'Bob Williams', avatarUrl: 'https://i.pravatar.cc/150?u=BobWilliams' },
  ...
  },
  {
    ...
    priority: Priority.HIGH,
    assignee: { name: 'Charlie Brown', avatarUrl: 'https://i.pravatar.cc/150?u=CharlieBrown' },
  ...
  },
  {
    ...
    assignee: { name: 'Diana Prince', avatarUrl: 'https://i.pravatar.cc/150?u=DianaPrince' },
    status: Status.TODO,
  ...
  },
  {
    ...
    assignee: { name: 'Ethan Hunt', avatarUrl: 'https://i.pravatar.cc/150?u=EthanHunt' },
    status: Status.DONE,
